...
##############
#########october 2013 remove message on the screen press a key to continue
####sept 2013 fixed dest folder with old version of input file and creation of empty fodlers
